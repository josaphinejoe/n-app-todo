...
import "./scheduler-example-view.scss";


@template(require("./scheduler-example-view.html"))
@element("scheduler-example")
export class SchedulerExampleViewModel extends ComponentViewModel
{
